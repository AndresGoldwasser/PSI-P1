...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        # Get fifth page and confirm it has (exactly) remaining 1 item
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Second user, no permisions
        test_user = User.objects.create_user(
            username='test_user2', password='pome_sassword')
        test_user.save()

    # Test for access without account
    def test_redirect_if_not_logged_in(self):
    ...
    # Test for access from a user without permission
    def test_forbidden_if_logged_in_but_not_correct_permission(self):
        login = self.client.login(username='test_user2', password='pome_sassword')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 403)
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        response = self.client.post(reverse('author-create'), valid_data)

        # Should create the author and redirect to its detail view
        new_author = Author.objects.get(first_name='Terry', last_name='Pratchett')
